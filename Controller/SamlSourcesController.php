<?php
/**
 * COmanage Registry SAML Source Controller
 *
...
class SamlSourcesController extends SOISController {
  // Class name, used by Cake
  public $name = "SamlSources";
  ...
  public function beforeRender() {
    $this->set('vv_available_attributes', $this->SamlSource->availableAttributes());
